...
void VulkanTutorialApplication::createImage(uint32_t width, uint32_t height, VkFormat format,
...
void VulkanTutorialApplication::transitionImageLayout(VkImage image, VkFormat format,
...
VkCommandBuffer VulkanTutorialApplication::beginSingleTimeCommands() {
...
void VulkanTutorialApplication::endSingleTimeCommands(VkCommandBuffer commandBuffer) {
...
void VulkanTutorialApplication::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width,
                                                  uint32_t height) {
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
VkImageView VulkanTutorialApplication::createImageView(VkImage image, VkFormat format) {
...
void VulkanTutorialApplication::createTextureImage() {
...
void VulkanTutorialApplication::createTextureImageView() {
    textureImageView = createImageView(textureImage, VK_FORMAT_R8G8B8A8_UNORM);
}

void VulkanTutorialApplication::createTextureSampler() {
